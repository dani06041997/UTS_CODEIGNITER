		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<a href="<?php echo site_url('kelas/create') ?>" type="button" class="btn btn-success">Create</a>								
							</div>
						</div>
					</div>	
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<?php foreach ($kelas_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('kelas/delete/').$key->id ?>" type="button" class="btn btn-danger" onclick="return deletechecked();">Delete</a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
